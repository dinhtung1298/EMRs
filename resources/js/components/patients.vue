<template>
    <div class="container">
        <div>
            ...
            <button type="button" @click="pdfExport()" class="btn btn-rounded btn-info"  style="color:#fff;">Print PDF</button>
            <a href="/clientsxml" class="btn btn-rounded btn-info"  style="color:#fff;">Print XML</a>
        </div> <br><br>
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr v-for="patient in patients" :key="patient.id">
                  ...
                  <td><barcode v-bind:value="patient.unique_id" format="CODE128" text=""></barcode></td>
